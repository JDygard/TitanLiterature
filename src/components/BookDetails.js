...
const BookDetails = () => (
  <section id="book-details">
    ...
    <p class="body_text">
    <h3>The debut novel of the Titan Chronology, “Children of Nemia” is available today</h3>
    <a href="#purchase" className="btn">Buy Now</a>
    </p>
    <p class="body_text"> 
      ASPIOJDPOSDJPASODJASPODJASPDOJ
    ...
    <p class="body_text"><img width="250px" src="images/bookcover_placeholder.png" alt="Children of Nemia" /></p>
    </div>
    </div>
